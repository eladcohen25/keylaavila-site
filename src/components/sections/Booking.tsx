...
export default function Booking() {
    ...
    <div className="space-y-10">
      <div>
        <h4 className="font-sans text-[11px] font-medium uppercase tracking-[0.18em] text-terracotta">
          {mode === "client" ? "For Clients" : "For Brands"}
        </h4>
        <p className="mt-3 font-sans text-sm font-light leading-relaxed text-text/70">
          {mode === "client"
            ? "Looking for personal training, group fitness, or Pilates instruction? Fill out the form and I'll get back to you within 48 hours to discuss your goals and find the right fit."
            : "Interested in a collaboration or partnership? I work with brands that align with my values in wellness, fitness, beauty, and lifestyle. Let's create something meaningful together."}
        </p>
      </div>
  ...
  // Mobile: zero framer-motion, plain HTML with CSS transitions
  if (mobile) {
    return (
        ...
        <Container>
          ...
          <div className="mx-auto mt-20 grid max-w-5xl gap-16 lg:grid-cols-12 lg:gap-20">
            <div className="lg:col-span-7">
              <ScrollReveal>
                <div className="mb-10 flex items-center justify-center gap-1 rounded-full border border-border p-1">
